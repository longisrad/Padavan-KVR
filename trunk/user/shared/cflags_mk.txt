...
ifdef CONFIG_RT_FIRST_IF_MT7915
...
ifeq ($(CONFIG_FIRMWARE_INCLUDE_MSD_LITE),y)
CFLAGS += -DAPP_MSD_LITE
endif
...
ifeq ($(CONFIG_FIRMWARE_INCLUDE_NATPIERCE),y)
CFLAGS += -DAPP_NATPIERCE
endif
...
ifeq ($(CONFIG_FIRMWARE_INCLUDE_SINGBOX),y)
CFLAGS += -DAPP_SINGBOX
endif
...
ifeq ($(CONFIG_FIRMWARE_INCLUDE_BAFA),y)
CFLAGS += -DAPP_BAFA
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_VIRTUALHERE),y)
CFLAGS += -DAPP_VIRTUALHERE
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_V2RAYA),y)
CFLAGS += -DAPP_V2RAYA
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_VNTS),y)
CFLAGS += -DAPP_VNTS
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_VNTCLI),y)
CFLAGS += -DAPP_VNTCLI
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_EASYTIER),y)
CFLAGS += -DAPP_EASYTIER
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_TAILSCALE),y)
CFLAGS += -DAPP_TAILSCALE
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_WXSEND),y)
CFLAGS += -DAPP_WXSEND
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_CLOUDFLARED),y)
CFLAGS += -DAPP_CLOUDFLARED
endif
ifeq ($(CONFIG_FIRMWARE_INCLUDE_ALIST),y)
CFLAGS += -DAPP_ALIST
endif
...
ifeq ($(CONFIG_FIRMWARE_INCLUDE_CLOUDFLARE),y)
CFLAGS += -DAPP_CLOUDFLARE
endif

ifeq ($(CONFIG_FIRMWARE_INCLUDE_NVPPROXY),y)
CFLAGS += -DAPP_NVPPROXY
endif
...
ifeq ($(CONFIG_FIRMWARE_INCLUDE_UUPLUGIN),y)
CFLAGS += -DAPP_UUPLUGIN
endif
