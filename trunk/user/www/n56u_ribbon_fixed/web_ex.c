...
static void
do_singbox_clients_file(const char *url, FILE *stream)
{
	dump_file(stream, "/tmp/singbox_clients.txt");
	fputs("\r\n", stream);
}
#endif
...
struct mime_handler mime_handlers[] = {
	...
	{ "singbox_clients.txt", "text/plain", no_cache_IE, NULL, do_singbox_clients_file, 1 },
#endif
#if defined(APP_SCUT)
