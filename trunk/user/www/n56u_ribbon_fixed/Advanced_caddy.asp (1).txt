...
<html>
<head>
<title><#Web_Title#> - File Manager</title>
...
<div class="wrapper">
	...
	<h2 class="box_head round_top">Online File Manager</h2>
	<div class="round_bottom">
	<div class="row-fluid">
	<div id="tabMenu" class="submenuBlock"></div>
	<div class="alert alert-info" style="margin: 10px;">File Browser is a lightweight Go-based file management system with login, role system, online PDF/image/video preview, upload/download, and packaged download.
	WebDAV is a file service similar to SMB, NFS, or FTP, but based on the HTTP/HTTPS protocol.
	...
	<tr>
	<th width="30%" style="border-top: 0 none;">Master Switch</th>
	...
	<input class="btn btn-success" style="width:150px" type="button" name="restartcaddy" value="Restart" onclick="button_restartcaddy()" />
	</td>
	</tr>
	</tr>
	<tr>
         <th width="30%">Startup Mode:</th>
         <td colspan="2">
	...
	<option value="3" <% nvram_match_x("","caddy_file", "3","selected"); %>>New Caddy File Browser</option>
	<option value="4" <% nvram_match_x("","caddy_file", "4","selected"); %>>New Caddy WebDAV</option>
	<option value="5" <% nvram_match_x("","caddy_file", "5","selected"); %>>New Caddy File Browser+WebDAV</option>
         </select>
         </td>
         </tr>
	<tr>
          <th width="30%">Program Path</th>
          <td colspan="2">
	...
	</div><br><span style="color:#888;">Custom path for the program, enter the full path and program name</span>
         </td>
         </tr>
	<tr id="row_ftit" style="display:none;">
	<th colspan="4" style="background-color: #756c78;" >File Browser Configuration</th>
	</tr>
	<tr id="row_fpath" style="display:none;">
         <th width="30%">File Browser Shared Directory</th>
         <td colspan="2">
	<div class="input-append">
	...
	<tr id="row_fport" style="display:none;">
          <th  width="30%">File Browser Port:</th>
          <td colspan="2">
          <input type="text" name="caddyf_wan_port" maxlength="5"  class="input" placeholder="12101" size="60" value="<% nvram_get_x("","caddyf_wan_port"); %>" />
	<input class="btn btn-success" style="" type="button" value="File Browser UI" onclick="on_caddyf_wan_port()" /></td>
          </td>
          </tr>
	<tr id="row_fwan" style="display:none;">
	<th width="30%">External IPv4 Access to File Browser</th>
	<td colspan="2">
	<div class="main_itoggle">
	...
	<th width="30%">External IPv6 Access to File Browser</th>
	<td colspan="2">
	<div class="main_itoggle">
	...
	<tr id="row_fname" style="display:none;">
          <th width="30%">File Browser Username:</th>
          <td colspan="2">
	...
	<th width="30%">File Browser Password</th>
	<td colspan="2">
	...
	<th colspan="4" style="background-color: #756c78;" >WebDAV Configuration</th>
	</tr>
	<tr id="row_davpath" style="display:none;">
         <th width="30%">WebDAV Shared Directory</th>
         <td colspan="2">
	<div class="input-append">
	...
	<tr id="row_davport" style="display:none;">
          <th  width="30%">WebDAV Port</th>
          <td colspan="2">
          <input type="text" name="caddyw_wan_port" maxlength="5"  class="input" size="60" placeholder="12102" value="<% nvram_get_x("","caddyw_wan_port"); %>" />
          <input class="btn btn-success" style="" type="button" value="WebDAV UI" onclick="on_caddyw_wan_port()" /></td>
          </tr>
	<tr id="row_wandav" style="display:none;">
	<th width="30%">External IPv4 Access to WebDAV</th>
	<td colspan="2">
	<div class="main_itoggle">
	...
	<th width="30%">External IPv6 Access to WebDAV</th>
	<td colspan="2">
	<div class="main_itoggle">
	...
	<tr id="row_wname" style="display:none;">
          <th width="30%">WebDAV Username</th>
          <td colspan="2">
	...
	<th width="30%">WebDAV Password</th>
	<td colspan="2">
	...
	<tr>
	<th colspan="4" style="background-color: #756c78;" >Config File Script</th>
	</tr>
	<tr id="row_post_wan_script">
	<td colspan="4">
	<i class="icon-hand-right"></i> <a href="javascript:spoiler_toggle('script2')"><span>Caddy script - do not modify if unsure!!!</span></a>
	<div id="script2">
	...
	<tr>
	<td colspan="4" style="border-top: 0 none;">
	<i class="icon-hand-right"></i> <a href="javascript:spoiler_toggle('caddylog')"><span>View Caddy log /tmp/caddy.log</span></a>
	...
	<tr>
	<td colspan="4" style="border-top: 0 none;">
	<i class="icon-hand-right"></i> <a href="javascript:spoiler_toggle('caddyfile')"><span>View Caddy config file /tmp/Caddyfile</span></a>
