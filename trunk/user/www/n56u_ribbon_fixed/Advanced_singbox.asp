...
function renderSubTable(){
	...
	tbody.empty();
	if (subList.length === 0) {
		tbody.append('<tr><td colspan="3" style="text-align:center; color:#888;">Chưa có Link Sub nào. Hãy nhập thông tin bên trên và nhấn "Thêm Thư mục".</td></tr>');
		return;
	}
...
<div class="wrapper">
	...
	<!-- KHUNG HIỂN THỊ LINK CLIENT (ẨN/HIỆN NICK) -->
