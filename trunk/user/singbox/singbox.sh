...
SYSTEM_BYPASS='"github.com", "githubusercontent.com", "raw.githubusercontent.com", "adguard.com", "adguard-dns.com", "adguardteam.github.io", "pool.ntp.org", "time.google.com", "testingcf.jsdelivr.net", "metacubex.one"'
